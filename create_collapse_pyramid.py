...
if __name__ == "__main__":
	...
	parser.add_argument('--input_file', '-i', default='tomato.png',
	...
	image = np.asarray(im)
	sp = steerable.SteerablePyramid(image, args.xres, args.yres, args.depth, args.orientation,args.image_name, args.out_dir, args.verbose)
